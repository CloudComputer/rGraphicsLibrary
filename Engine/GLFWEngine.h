#ifndef _GLFWENGINE_H_
#define _GLFWENGINE_H_
...
class GLFWEngine : public Engine{
	GLFWEngine(std::string title,glm::ivec2 winSize);
	virtual ~GLFWEngine();
...
public:
	...
	static GLFWEngine* getEngine();
	static GLFWEngine* CreateEngine(std::string title = "Unamed window",glm::ivec2 winSize = glm::ivec2(400,400));
