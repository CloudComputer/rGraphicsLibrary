...
glm::vec3 BoundingAABB::getPosition( glm::vec3 t )
{
	return _minPos + (_maxPos-_minPos) * t;
}

glm::vec3 BoundingAABB::getInternalPosition(glm::vec3 worldPos){
	glm::vec3 pos;
...
glm::vec3 BoundingAABB::getDiscretePosition( glm::vec3 worldPos, glm::ivec3 dim )
{
